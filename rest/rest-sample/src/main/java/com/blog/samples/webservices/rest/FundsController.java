...
public class FundsController {
    ...
    public ModelAndView updateFund(@RequestBody final Fund fund_p, final @PathVariable("fundId") String fundId_p, final HttpServletResponse httpResponse_p) {
    ...
    public ModelAndView removeFund(final @PathVariable("fundId") String fundId_p, final HttpServletResponse httpResponse_p) {
     ...
     * Injector methods.
     *
     * @param fundService_p the new fund service
     */
