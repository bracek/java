 ...
 * @author katrami
 */
public abstract class AbstractGenerator extends AbstractLoadData implements Generator {
        ...
        try {
            ...
            try {
                ...
                while ((line = input.readLine()) != null) {
                    String[] res = line.split(SeparatorConst.Separator.TABULATOR_SEPARATOR.getSeparatorValue());
...
//        String excludeList = phonemeFileReader.getFileContent(excludeFile);
        String excludeList = getFileContent(excludeFile);
