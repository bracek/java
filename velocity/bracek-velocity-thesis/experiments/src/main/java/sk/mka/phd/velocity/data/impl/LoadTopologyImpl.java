 ...
 * @date Nov 29, 2009
 */
public class LoadTopologyImpl extends AbstractFileLoadData {

    private static Logger log = Logger.getLogger(LoadTopologyImpl.class);
...
//            numbers = super.loadData(filename);
            for (int i = 0; i < numbers.length; i++) {
                ...
                for (int j = 0; j < strings.length; j++) {
                    ...
                    for (Const.Topology param : Const.Topology.values()) {
