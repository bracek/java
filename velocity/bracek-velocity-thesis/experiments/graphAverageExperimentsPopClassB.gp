...
plot "graphAverageExperimentsPopClassB.dat" using 1:2 ls 1 with lines title "priemerna uspesnost NN-sieti pre neznele fonemy",\
   "graphAverageExperimentsPopClassB.dat" using 1:3 ls 2 with lines title "priemerna uspesnost experimentov pre fonemy triedy A", \
   "graphAverageExperimentsPopClassB.dat" using 1:4 ls 3 with lines title "priemerna uspesnost experimentov  pre fonemy triedy B"   
