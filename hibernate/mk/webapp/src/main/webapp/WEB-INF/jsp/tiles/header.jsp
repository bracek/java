...
<div class="header" style="height: 100px; background:#c5e6ef;">
    <div style="position: absolute; text-align: right; margin-right: 10px;"><img src="<c:url value="/img/ixonos_logo_main.jpg"/>"/></div>
    <div>&nbsp;</div>
    <div style="text-align: right; margin-right: 10px;">
        ...
        <security:authentication property="principal.fullName"/>&nbsp;[<security:authentication property="principal.username"/>]        
        &nbsp;<a href="<c:url value="/logout"/>"><fmt:message key="header.logout"/></a>
    </div>
    <div style="text-align: right; margin-right: 10px;">
