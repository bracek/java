...
<h3>
	<fmt:message key="message.heading" />
</h3>
<table border="0" cellspacing="3" cellpadding="1">
		...
		<c:forEach items="${messages}" var="message" varStatus="status">
			<tr id="product${message.id}">
				...
				<td class="alignRight"><a
					href="../../menu/message/editMessage.do?id=${message.id}"> <img
						alt="<fmt:message key='edit'/>" title="<fmt:message key='edit'/>"
						src="../../img/icons/edit.png" />
				</a></td>

				<td class="alignRight"><a
					href="../../menu/message/deleteMessage.do?<%=ApplicationCodes.MESSAGE.COMMAND%>=${message.id}">
	...
	<tr>
		<td colspan="5" class="tableFooter"><a
			href="../../menu/message/editMessage.do"> <img
