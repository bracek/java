...
<h1>
	<fmt:message key="users.edit.title.head" />
</h1>
<fieldset>
	<legend>
		<fmt:message key="users.edit.legend" />
	</legend>
	<c:url var="url" value="/users/save.do" />
	<form:form action="${url}" commandName="<%=UsersController.USERS%>"
		method="post">
		...
		<table border="1">
			...
			afea
			<tr>
				<td><form:label path="username" for="username">
						<fmt:message key="form.name" />:</form:label></td>
				<td>
					<div class="form-error-message">
						<form:errors path="username" />
					</div> <form:input id="username" path="username"
