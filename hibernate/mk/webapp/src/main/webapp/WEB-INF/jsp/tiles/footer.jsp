...
<div class="footer" style="height: 60px; background: #c5e6ef;">
	...
	<div style="text-align: right; margin-right: 10px;">
		Ixonos SkillNet - <fmt:message key="footer.version"/><%= SkillnetInitServlet.props.get("skillnet.version") %> &copy; 2009 Ixonos
	</div>
	<div style="text-align: right; margin-right: 10px;"><fmt:message key="locale.changeLanguage" />: 
