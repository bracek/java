...
<form:form modelAttribute="address">
	...
	<fieldset>
		...
		<div class="form-row">
			<label for="city"><fmt:message key="address.form.city" />:</label> <span
				class="input"><form:input path="city" /></span>
		</div>
		<div class="form-row">
		...
		<div class="form-row">
			<label for="zipPostal"><fmt:message
					key="address.form.zipPostal" />:</label> <span class="input"><form:input
					path="zipPostal" /></span>
		</div>
		<div class="form-row">
		...
		<div class="form-buttons">
			<div class="button">
				<input type="submit" id="save" name="_eventId_save"
					...
					onclick="Spring.remoting.submitForm('save', 'address')" />&#160; <input
