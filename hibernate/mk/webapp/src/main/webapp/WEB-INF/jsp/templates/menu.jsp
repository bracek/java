...
<div id="side-bar">
	...
	<security:authorize ifAnyGranted="ROLE_USER, ROLE_GROUP_MANAGER">
		<span class="title"><img
			src="<c:url value="/img/menu_title_arrow.gif"/>" class="arrow" /> <fmt:message
				key="menu.skills" /></span>
		<div class="submenu">
	...
	<security:authorize ifAnyGranted="ROLE_USER">
		<p>Menu</p>
		<p>
			<a href="<c:url value="/person.do"/>"><fmt:message
					key="button.create" /></a>
		</p>
		<p>
			<a href="<c:url value="/person/search.do"/>"><fmt:message
					key="button.search" /></a>
		</p>
        ...
        -->
		<p>
			<a href="<c:url value="/anonymous/about.do"/>"><fmt:message
					key="menu.about" /></a>
		</p>
		<p>
			<a href="<c:url value="/anonymous/curriculum.do"/>"><fmt:message
					key="menu.curriculum" /></a>
		</p>
		<p>
			<a href="<c:url value="/menu/message/viewMessages.do"/>"><fmt:message
					key="menu.insertMessage" /></a>
		</p>
	</security:authorize>
	...
	<secure:authorize ifAnyGranted="ROLE_GROUP_MANAGER">
		...
		<security:authorize ifAnyGranted="ROLE_GROUP_MANAGER">
			<p>
				<a href="<c:url value="/register.do"/>"><fmt:message
						key="menu.product" /></a>
			</p>
		</security:authorize>
		...
		<security:authorize ifAnyGranted="ROLE_GROUP_MANAGER">
			<p>
				<a href="<c:url value="/book/viewBooks.do"/>"><fmt:message
						key="submenu.insertBook" /></a>
			</p>
		</security:authorize>
	</secure:authorize>
