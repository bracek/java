...
<form:form action="${url}" commandName="<%=OsobaController.OSOBA%>"
	method="post">
	<form:hidden path="id" />
	...
	<fieldset>
		...
		<div class="form-row">
			<label for="password-repete"><fmt:message
					key="person.form.password" />:</label> <span class="input"><form:password
					path="password_repeat" /></span>
		</div>
