...
public class DeleteMessageController {
    ...
    // -------------------------------- ATTRS ----------------------------------
    /** The logger. */
    private static final Log logger = LogFactory.getLog(DeleteMessageController.class);
    ...
    public String handle(@RequestParam(value = ApplicationCodes.MESSAGE.COMMAND, required = false) Integer id, HttpServletRequest request) throws Exception {
