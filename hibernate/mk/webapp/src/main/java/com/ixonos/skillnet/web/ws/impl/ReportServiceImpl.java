...
/**
 * Created by IntelliJ IDEA. User: hustasl Date: Apr 7, 2009 Time: 10:55:36 AM
...
public class ReportServiceImpl implements ReportService {
	...
	@Override
	public WSReport getReportById(final Integer reportId) {
		final WSReport wsReport = new WSReport();
		...
		return wsReport; // To change body of implemented methods use File |
