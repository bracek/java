...
public class ProductDaoImpl extends SimpleJdbcDaoSupport implements ProductDao {
    ...
    private static final String INSERT = "INSERT INTO product (id, price, description) values (nextVal('product_id'), :price, :desc)";
     ...
     */
    @Autowired
    public ProductDaoImpl(@Qualifier("dataSource") DataSource datasource) {
