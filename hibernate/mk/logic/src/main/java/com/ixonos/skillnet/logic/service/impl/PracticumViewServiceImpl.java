...
public final class PracticumViewServiceImpl extends AbstractGenericService<PracticumView> implements PracticumViewService {
    ...
    public List<PracticumView> getPracticumsWithSkills(final List<String> skills,
final  List<Integer> levels) {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<String> getUsersWithSkills(final List<String> skills,
final  List<Integer> levels) {
     ...
     * @return
     */
    private DetachedCriteria getUsersWithSkillsCriteria(final List<String> skills,
final  List<Integer> levels) {		
