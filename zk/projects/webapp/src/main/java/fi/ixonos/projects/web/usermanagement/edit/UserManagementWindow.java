...
//        Users readUser = (Users) ((Listitem) getParentComponent(lb, Listitem.class)).getValue();
...
//            readUser.setAuthorities(sb.toString());
//            this.lastEditedAuthorities = selectedAuthorities;
//            this.lastEditedAuthoritiesUserName = userName;
//            UsersService usersService = (UsersService) ProjectsApplicationContext.getApplicationContext().getBean("usersService");
//            try {
...
//            }
//        }
//        GroupsService groupsService = (GroupsService) ProjectsApplicationContext.getApplicationContext().getBean("groupsService");
//        try {
