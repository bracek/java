	...
	<tbody>
		<tr>
            ...
            for example: pricipal.fullName == skillnetUser.getFullName() --%>
				<fmt:message key="header.loggeduser" />:&nbsp; <security:authentication
					property="principal.fullName" />&nbsp;[<security:authentication
					property="principal.username" />] &nbsp;<a
				href="<c:url value="/logout"/>"><fmt:message key="header.logout" /></a>
			</td>
		</tr>
		<tr>
			<td align="right">
