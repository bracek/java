...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
            ...
            <title>Projects - <fmt:message key="${titleKey}"/></title>
    ...
    <body>
        <table id="layoutTable" border="0" cellpadding="0" cellspacing="0"width="100%" height="100%">
            ...
            <tr valign="bottom" height="30">
                <td class="main" colspan="2"><tiles:insertAttribute name="footer"/></td>
            </tr>
        </table>
    </body>
</html>
