...
<table   border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td>
            ...
            <!-- projects -->
            <security:authorize ifAnyGranted="ROLE_GROUP_MANAGER, ROLE_ADMIN">
                <div class="sdmenu">
                    <span class="title"><img alt=""  src="<c:url value="/img/menu_title_arrow.gif"/>" class="arrow"/><fmt:message key="menu.projects" /></span>
                    <div class="submenu">
                        <a href='<c:url value="/projects/editProject.do"/>'><fmt:message key="menu.projects.edit" /></a>
                    </div>
                    <div class="submenu">
                        <a href='<c:url value="/projects/timeline.do"/>'><fmt:message key="menu.projects.timeline" /></a>
                    </div>
                    <div class="submenu">
                        <a href='<c:url value="/projects/editAllocation.do"/>'><fmt:message key="menu.projects.allocation" /></a>
                    </div>
                </div>
            </security:authorize>

            <!-- usermanagement -->
            <security:authorize ifAnyGranted="ROLE_USER, ROLE_GROUP_MANAGER, ROLE_ADMIN">
                ...
                <div class="sdmenu">
                    ...
                    <div class="submenu">
                        ...
                        <security:authorize ifAnyGranted="ROLE_ADMIN">
                            ...
                            <a href='<c:url value="/usermanagement/usermanagementImport.do"/>'><fmt:message key="menu.usermanagement.import" /></a>
                        </security:authorize>
                    </div>
                </div>
            </security:authorize>
