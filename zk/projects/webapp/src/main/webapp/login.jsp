            ...
            <form name="f" action="<c:url value="/j_security_check"/>" method="POST">
                ...
                <table style="font-size: 12px;" class="header">
                    ...
                    <tr align="center">
                        ...
                        <td><input style="width:150px" type='password' name='j_password'></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td colspan="2"><input type="checkbox"
                                               name="_spring_security_remember_me" id="_spring_security_remember_me"><label
                                               for="_spring_security_remember_me">Don't ask for my password for two weeks</label>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
...
<!--                        <td><a href='<c:url value="/usermanagement/usersAdd.do"/>'><fmt:message key="menu.usermanagement.add" />Register</a></td>-->
                        <td colspan="2">
                            <table>
                                <tr>
                                    <td width="190px"><input name="submit" type="submit" value="Log In"></td>
