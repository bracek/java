...
public class ProductDaoImpl extends SimpleJdbcDaoSupport implements ProductDao {
	...
	private static final String INSERT = "INSERT INTO product (id, price, description) values (nextVal('product_seq'), :price, :desc)";
	private static final String UPDATE = "UPDATE product set (price, description) = (:price, :desc) WHERE id = :id";
	 ...
	 */
	@Autowired
	public ProductDaoImpl(@Qualifier("dataSourceTarget") DataSource datasource) {
	...
	/* (non-Javadoc)
	 * @see stibrik.springapp.dao.ProductDao#updateProduct(stibrik.springapp.bean.Product)
	 */
	public void updateProduct(Product prod) {
		...
		logger.debug("updateProduct(): Product updated, " + rowNum + " affected.");
	}
	
	/* (non-Javadoc)
	 * @see stibrik.springapp.dao.ProductDao#addProduct(stibrik.springapp.bean.Product)
	 */
	...
	private class GeneralQuery extends MappingGenericQuery<Product> {
        ...
        /* (non-Javadoc)
         * @see stibrik.springapp.dao.util.MappingGenericQuery#mapRow(ResultSet, int)
         */
        @Override
