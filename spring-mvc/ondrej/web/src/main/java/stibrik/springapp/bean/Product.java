...
public class Product implements Serializable {
	...
	public String toString() {
		...
		retValue.append("Product ( ").append(super.toString()).append(TAB)
				.append("id = ").append(id).append(TAB).append("price = ")
				.append(price).append(TAB).append("description = ")
				.append(description).append(TAB).append(" )");
