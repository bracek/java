...
<div class="alignCenter">
	...
	<p><fmt:message key="hello.text"/> <c:out value="${now}"/></p>
	<div style="padding-top:30px;">
		<img id="nokia" alt="<fmt:message key='nokia_n95'/>" title="<fmt:message key='nokia_n95'/>" src="img/nokia-n95.png" class="link"/>
	</div>
